  ...
  return (
    ...
    >
      ...
      {actionLabel && actionHref ? (
        <Link
          href={actionHref}
          className="ntv-btn mt-4 inline-flex items-center justify-center rounded-full px-5 py-2 text-xs font-bold text-[#121212] transition-transform hover:scale-105"
